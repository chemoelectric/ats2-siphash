...
implement_test_64(`test_halfsiphash_2_4_64',`
  val (h1a, h2a) = halfsiphash_2_4_64 (!(addr@ input), i, key)
  var h1 = h1a
  var h2 = h2a
  val _ = put_two_uint32 (output, h1, h2)')

implement_test_64(`test_halfsiphash_2_4_output____64',`
  val _ = halfsiphash_2_4_output (!(addr@ input), i, key,
                                  output, i2sz 8)')

implement_test_64(`test_halfsiphash_c_d_64____2_4',`
...
main0 () =
  {
    val _ = test_halfsiphash_2_4_64 ()
    val _ = test_halfsiphash_2_4_output____64 ()
    val _ = test_halfsiphash_c_d_64____2_4 ()
  }

...
implement_test_64(`test_siphash_4_8____64',`
  siphash_4_8 (input, i, key, output, 8);')

implement_test_64(`test_siphash_c_d____4_8_64',`
  siphash_c_d (input, i, key, 4, 8, output, 8);')

int
main (int argc, char *argv[])
{
  test_siphash_4_8____64 ();
  test_siphash_c_d____4_8_64 ();
}

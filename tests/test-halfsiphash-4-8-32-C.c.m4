...
implement_test_32(`test_halfsiphash_4_8____32',`
  halfsiphash_4_8 (input, i, key, output, 4);')

implement_test_32(`test_halfsiphash_c_d____4_8_32',`
  halfsiphash_c_d (input, i, key, 4, 8, output, 4);')

int
main (int argc, char *argv[])
{
  test_halfsiphash_4_8____32 ();
  test_halfsiphash_c_d____4_8_32 ();
}

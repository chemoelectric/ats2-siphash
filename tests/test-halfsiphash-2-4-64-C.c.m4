...
implement_test_64(`test_halfsiphash_2_4____64',`
  halfsiphash_2_4 (input, i, key, output, 8);')

implement_test_64(`test_halfsiphash_c_d____2_4_64',`
  halfsiphash_c_d (input, i, key, 2, 4, output, 8);')

int
main (int argc, char *argv[])
{
  test_halfsiphash_2_4____64 ();
  test_halfsiphash_c_d____2_4_64 ();
}

...
implement_test_32(`test_halfsiphash_4_8_32_hats',`
  (* Test the template interface. *)
  implement {} halfsiphash$crounds () = 4U
  implement {} halfsiphash$drounds () = 8U
  var h = halfsiphash_32 (!(addr@ input), i, key)
  val _ = put_uint32 (output, h)')

implement_test_32(`test_halfsiphash_4_8_output_hats____32',`
  (* Test the template interface. *)
  implement {} halfsiphash$crounds () = 4U
  implement {} halfsiphash$drounds () = 8U
...
main0 () =
  {
    val _ = test_halfsiphash_4_8_32_hats ()
    val _ = test_halfsiphash_4_8_output_hats____32 ()
  }

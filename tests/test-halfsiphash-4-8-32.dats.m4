...
implement_test_32(`test_halfsiphash_4_8_32',`
  var h = halfsiphash_4_8_32 (!(addr@ input), i, key)
  val _ = put_uint32 (output, h)')

implement_test_32(`test_halfsiphash_4_8____32',`
  var h = halfsiphash_4_8 (!(addr@ input), i, key)
  val _ = put_uint32 (output, h)')

implement_test_32(`test_halfsiphash_4_8_output____32',`
  val _ = halfsiphash_4_8_output (!(addr@ input), i, key,
                                  output, i2sz 4)')

implement_test_32(`test_halfsiphash_4_8____output_32',`
  val _ = halfsiphash_4_8 (!(addr@ input), i, key,
                           output, i2sz 4)')

implement_test_32(`test_halfsiphash_c_d_32____4_8',`
  var h = halfsiphash_c_d_32 (!(addr@ input), i, key, 4U, 8U)
  val _ = put_uint32 (output, h)')

implement_test_32(`test_halfsiphash_c_d____32_4_8',`
  var h = halfsiphash_c_d (!(addr@ input), i, key, 4U, 8U)
  val _ = put_uint32 (output, h)')
...
main0 () =
  {
    val _ = test_halfsiphash_4_8_32 ()
    val _ = test_halfsiphash_4_8____32 ()
    val _ = test_halfsiphash_4_8_output____32 ()
    val _ = test_halfsiphash_4_8____output_32 ()
    val _ = test_halfsiphash_c_d_32____4_8 ()
    val _ = test_halfsiphash_c_d____32_4_8 ()
  }

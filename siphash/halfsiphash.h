...
void halfsiphash_2_4 (const void *in, const size_t inlen,
                      const void *k,
                      uint8_t *out, const size_t outlen);

/* Similar to halfsiphash_2_4, but for the more conservative
   implementation. */
void halfsiphash_4_8 (const void *in, const size_t inlen,
                      const void *k,
                      uint8_t *out, const size_t outlen);

/* This variant accepts crounds and drounds as arguments.  */
void halfsiphash_c_d (const void *in, const size_t inlen,
                      const void *k,
                      unsigned int crounds, unsigned int drounds,
                      uint8_t *out, const size_t outlen);

#endif /* SIPHASH_HALFSIPHASH_HEADER_GUARD__ */
